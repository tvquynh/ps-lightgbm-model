...
#    file = request.files['uploadFile']
    ...
    if file:
        ...
        msg  = 'Invalid Upload'
    html_result = result + '<br><img src="/static/uploads/' + filenameimage + '" class="img-thumbnail" width="300" height="250" />'
    return html_result #jsonify({'htmlresponse': render_template('response.html', msg=result, filenameimage=filenameimage)})
